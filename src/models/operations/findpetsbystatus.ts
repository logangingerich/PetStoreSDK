...
export type FindPetsByStatusResponse = Uint8Array | string | Array<components.Pet2>;
...
/** @internal */
export type FindPetsByStatusResponse$Outbound = Uint8Array | Array<components.Pet2$Outbound>;
