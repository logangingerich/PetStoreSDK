...
import { CreateUserFormAcceptEnum, userCreateUserForm } from "../funcs/userCreateUserForm.js";
import { CreateUserJsonAcceptEnum, userCreateUserJson } from "../funcs/userCreateUserJson.js";
import { CreateUserRawAcceptEnum, userCreateUserRaw } from "../funcs/userCreateUserRaw.js";
import {
...
import { GetUserByNameAcceptEnum, userGetUserByName } from "../funcs/userGetUserByName.js";
...
export class User extends ClientSDK {
    ...
    async createUserJson(
        request?: ReadableStream<Uint8Array> | Blob | ArrayBuffer | Buffer | undefined,
        options?: RequestOptions & { acceptHeaderOverride?: CreateUserJsonAcceptEnum }
    ): Promise<operations.CreateUserJsonResponse> {
        return unwrapAsync(userCreateUserJson(this, request, options));
    }
    ...
    async createUserRaw(
        ...
        return unwrapAsync(userCreateUserRaw(this, request, options));
    }
    ...
    async createUserForm(
        ...
        return unwrapAsync(userCreateUserForm(this, request, options));
    }
    ...
    async createUsersWithListInput(
        request?: Array<ReadableStream<Uint8Array> | Blob | ArrayBuffer | Buffer> | undefined,
    ...
    async updateUserJson(
        ...
        return unwrapAsync(userUpdateUserJson(this, request, options));
    }
    ...
    async updateUserRaw(
        ...
        return unwrapAsync(userUpdateUserRaw(this, request, options));
    }
    ...
    async updateUserForm(
        ...
        return unwrapAsync(userUpdateUserForm(this, request, options));
    }
