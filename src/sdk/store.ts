...
import { GetOrderByIdAcceptEnum, storeGetOrderById } from "../funcs/storeGetOrderById.js";
...
export class Store extends ClientSDK {
    ...
    async getInventory(
        ...
        return unwrapAsync(storeGetInventory(this, security, options));
    }
    ...
    async placeOrderJson(
        ...
        return unwrapAsync(storePlaceOrderJson(this, request, options));
    }
    ...
    async placeOrderRaw(
        ...
        return unwrapAsync(storePlaceOrderRaw(this, request, options));
    }
    ...
    async placeOrderForm(
        ...
        return unwrapAsync(storePlaceOrderForm(this, request, options));
    }
