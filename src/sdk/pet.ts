...
import { FindPetsByStatusAcceptEnum, petFindPetsByStatus } from "../funcs/petFindPetsByStatus.js";
import { FindPetsByTagsAcceptEnum, petFindPetsByTags } from "../funcs/petFindPetsByTags.js";
import { GetPetByIdAcceptEnum, petGetPetById } from "../funcs/petGetPetById.js";
import { petUpdatePetForm, UpdatePetFormAcceptEnum } from "../funcs/petUpdatePetForm.js";
import { petUpdatePetJson, UpdatePetJsonAcceptEnum } from "../funcs/petUpdatePetJson.js";
import { petUpdatePetRaw, UpdatePetRawAcceptEnum } from "../funcs/petUpdatePetRaw.js";
...
export class Pet extends ClientSDK {
    ...
    async updatePetForm(
        ...
        return unwrapAsync(petUpdatePetForm(this, request, options));
    }
    ...
    async updatePetJson(
        ...
        return unwrapAsync(petUpdatePetJson(this, request, options));
    }
    ...
    async updatePetRaw(
        ...
        return unwrapAsync(petUpdatePetRaw(this, request, options));
    }
    ...
    async addPetJson(
        ...
        return unwrapAsync(petAddPetJson(this, request, options));
    }
    ...
    async addPetRaw(
        ...
        return unwrapAsync(petAddPetRaw(this, request, options));
    }
    ...
    async addPetForm(
        ...
        return unwrapAsync(petAddPetForm(this, request, options));
    }
    ...
    async getPetById(
        ...
        return unwrapAsync(petGetPetById(this, request, security, options));
    }
    ...
    async updatePetWithForm(
        ...
        return unwrapAsync(petUpdatePetWithForm(this, request, options));
    }

    /**
     * Deletes a pet
     */
    async deletePet(request: operations.DeletePetRequest, options?: RequestOptions): Promise<void> {
