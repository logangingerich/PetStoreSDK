 ...
 */
export async function petUpdatePetForm(
    ...
    Result<
        operations.UpdatePetFormResponse,
        | SDKError
        | SDKValidationError
        | UnexpectedClientError
        | InvalidRequestError
...
> {
    ...
    const [result$] = await m$.match<
        ...
        | ConnectionError
    >(
        m$.bytes(200, operations.UpdatePetFormResponse$inboundSchema, { ctype: "application/xml" }),
        m$.json(200, operations.UpdatePetFormResponse$inboundSchema),
