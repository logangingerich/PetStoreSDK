...
export async function userGetUserByName(
    ...
    Result<
        operations.GetUserByNameResponse,
        | SDKError
        | SDKValidationError
        | UnexpectedClientError
        | InvalidRequestError
...
> {
    ...
    const [result$] = await m$.match<
        ...
        | ConnectionError
    >(
        m$.bytes(200, operations.GetUserByNameResponse$inboundSchema, { ctype: "application/xml" }),
        m$.json(200, operations.GetUserByNameResponse$inboundSchema),
