...
> {
    ...
    const [result$] = await m$.match<
        ...
        | ConnectionError
    >(
        m$.bytes(200, operations.CreateUsersWithListInputResponse$inboundSchema.optional(), {
            ctype: "application/xml",
        }),
        m$.json(200, operations.CreateUsersWithListInputResponse$inboundSchema.optional()),
        m$.fail(["4XX", "5XX"]),
        m$.nil("default", operations.CreateUsersWithListInputResponse$inboundSchema.optional())
    )(response);
    if (!result$.ok) {
        return result$;
    }
