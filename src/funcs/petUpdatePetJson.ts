 ...
 */
export async function petUpdatePetJson(
    ...
    Result<
        operations.UpdatePetJsonResponse,
        | SDKError
        | SDKValidationError
        | UnexpectedClientError
        | InvalidRequestError
...
> {
    ...
    const [result$] = await m$.match<
        ...
        | ConnectionError
    >(
        m$.bytes(200, operations.UpdatePetJsonResponse$inboundSchema, { ctype: "application/xml" }),
        m$.json(200, operations.UpdatePetJsonResponse$inboundSchema),
